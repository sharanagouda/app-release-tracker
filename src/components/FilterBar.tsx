...
export const FilterBar: React.FC<FilterBarProps> = ({
  ...
  return (
    <div className={`rounded-lg shadow-sm border p-4 mb-6 space-y-4 ${darkMode
      ...
      <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
        ...
        <div className="flex flex-col sm:flex-row gap-4 flex-1 w-full">
          <div className="relative w-full sm:w-[500px]">
            ...
            <input
              type="text"
              placeholder="Search releases, versions, or descriptions..."
              value={searchTerm}
              onChange={(e) => onSearchChange(e.target.value)}
              className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${darkMode
          ...
          <div className="flex gap-2 flex-wrap">
            <select
              ...
              className={`px-3 py-2 pr-8 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none ${darkMode
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full lg:w-auto items-center">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2">
            <Calendar className={`h-4 w-4 hidden sm:block ${darkMode ? 'text-gray-500' : 'text-gray-400'
              }`} />
            <input
              type="date"
              ...
              className={`px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm ${darkMode
                ? 'bg-gray-700 border-gray-600 text-gray-100'
                : 'bg-white border-gray-300 text-gray-900'
                }`}
            />
