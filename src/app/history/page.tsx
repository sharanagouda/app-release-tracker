  ...
  return (
    <DashboardLayout>
      <div className="p-6 md:p-8 w-full">
        <div className="mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Deployment History</h1>
          <p className="mt-1 text-sm text-gray-500">
            View all deployment activities across your applications
          </p>
        </div>
        ...
        <div className="flex h-96 items-center justify-center rounded-xl border-2 border-dashed border-gray-300 bg-gray-50">
          <div className="text-center px-4">
            ...
            <p className="mt-2 text-sm text-gray-500">
              Deployment history will be available here
            </p>
          </div>
        </div>
      </div>
